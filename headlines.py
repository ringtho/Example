...
WEATHER_url = "http://api.openweathermap.org/data/2.5/weather?q={}&units=metric&appid=8140875d926ee293a487373cb658e2c8"
CURRENCY_URL ="https://openexchangerates.org//api/latest.json?app_id=fb53a386d0804373be1fb909f2e53174"
...
def home():
	...
	# articles = request.args.get(publication)
	# if not publication:
